...
public class PharmacyLoginProjectMenu {
	...
	public static MenuBar getMneuBar() {
		...
		menuFile.getItems().addAll(itemLogIN, itemExit);
		...
		itemTransaction.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				NewTransictionForm pharmacyTransiction = new NewTransictionForm(PharmacyProjectScene.primarySatge);
			}
		});
		 ...
		 */
//		menuBar.getMenus().addAll(menuFile, menuHomeButton, menuTransaction, menuMedicine,menuCustomer,
//				menuEmployee, menuStorage, menuReport, menuSettings, menuAbout, menuHelp);
		menuBar.getMenus().addAll(menuFile, menuAbout, menuHelp);
