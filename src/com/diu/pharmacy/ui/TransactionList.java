...
public class TransactionList {
	...
	private TableView<Transiction> tbl = new TableView<Transiction>();
	private TableColumn<Transiction, String> transactionNo = new TableColumn<>("Transaction No");
	private TableColumn<Transiction, String> transactionDate = new TableColumn<>("Date");
	private TableColumn<Transiction, String> transactionCustomer = new TableColumn<>("Customer");
	private TableColumn<Transiction, String> transactionServiceProvider = new TableColumn<>("Service Provider");
	private TableColumn<Transiction, String> transactionPayableAmount = new TableColumn<>("Payable Amount");
	private TableColumn<Transiction, String> transactionEdit = new TableColumn<>("Edit");
	private TableColumn<Transiction, String> transactionDelete = new TableColumn<>("Delete");
	...
	public TransactionList(Stage stage) {
		this.stage = stage;
				...
				TableCell<Transiction, String> cell = new TableCell<Transiction, String>() {
					...
					public void updateItem(String item, boolean empty) {
						...
						if (empty) {
							...
							editImage.setImage(
									new Image(TransactionList.class.getResource("/images/view.png").toString()));
				...
				TableCell<Transiction, String> cell = new TableCell<Transiction, String>() {
					...
					public void updateItem(String item, boolean empty) {
						...
						if (empty) {
							...
							ImageView editImage = new ImageView();
							editImage.setImage(
									new Image(TransactionList.class.getResource("/images/edit.png").toString()));
					...
					public void updateItem(String item, boolean empty) {
						...
						if (empty) {
							...
							deleteImage.setImage(
									new Image(TransactionList.class.getResource("/images/delete.png").toString()));
