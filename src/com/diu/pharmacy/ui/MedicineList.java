...
public class MedicineList {
	...
	private TableColumn<Medicine, String> medicineName = new TableColumn<>("Name");
	private TableColumn<Medicine, String> medicineGenericName = new TableColumn<>("Date");
	...
	public MedicineList(Stage stage) {
		this.stage = stage;
	...
	public Scene addList() {
		...
		medicineName.setCellValueFactory(new PropertyValueFactory<>("transictionNo"));
		medicineGenericName.setCellValueFactory(new PropertyValueFactory<>("transictionDate"));
				...
				TableCell<Transiction, String> cell = new TableCell<Transiction, String>() {
					...
					public void updateItem(String item, boolean empty) {
						...
						if (empty) {
							...
							editImage.setImage(new Image(MedicineList.class.getResource("/images/view.png").toString()));
				...
				TableCell<Transiction, String> cell = new TableCell<Transiction, String>() {
					...
					public void updateItem(String item, boolean empty) {
						...
						if (empty) {
							...
							ImageView editImage = new ImageView();
							editImage.setImage(new Image(MedicineList.class.getResource("/images/edit.png").toString()));
				...
				TableCell<Transiction, String> cell = new TableCell<Transiction, String>() {
					...
					public void updateItem(String item, boolean empty) {
						...
						if (empty) {
							...
							deleteImage.setImage(new Image(MedicineList.class.getResource("/images/delete.png").toString()));
...
//		transactionDelete.setCellFactory(delete);
		...
		tbl.getColumns().addAll(medicineName, medicineGenericName, transactionCustomer, transactionServiceProvider,
