...
public class CheckExpireList {
	...
	public CheckExpireList(Stage stage) {
		this.stage = stage;
				...
				TableCell<Transiction, String> cell = new TableCell<Transiction, String>() {
					...
					public void updateItem(String item, boolean empty) {
						...
						if (empty) {
							...
							editImage.setImage(new Image(CheckExpireList.class.getResource("/images/view.png").toString()));
				...
				TableCell<Transiction, String> cell = new TableCell<Transiction, String>() {
					...
					public void updateItem(String item, boolean empty) {
						...
						if (empty) {
							...
							ImageView editImage = new ImageView();
							editImage.setImage(new Image(CheckExpireList.class.getResource("/images/edit.png").toString()));
				...
				TableCell<Transiction, String> cell = new TableCell<Transiction, String>() {
					...
					public void updateItem(String item, boolean empty) {
						...
						if (empty) {
							...
							deleteImage.setImage(new Image(CheckExpireList.class.getResource("/images/delete.png").toString()));
